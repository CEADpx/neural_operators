...
These folders can be found in the subdirectory `survey_work/applications/bayesian_inverse_problem_poisson/processed_results/` [NeuralOperator_Survey_Shared_Data_March2025](https://www.dropbox.com/scl/fo/5dg02otewg7j0bt7rhkuf/AOfAAc2SaWOgO-Yg25IlTXs?rlkey=t900geej8y8z327y5f8wu4yc9&st=t9c8qimk&dl=0). That folder also contains the notebook to process the Bayesian inference results from the ``true" and surrogate models. 
